...
import { customRenderWithMaster, customRenderWithNotMaster } from '@/test-utils';

describe('NextRoundButton 컴포넌트 테스트', () => {
  it('방장은 활성화 되어 있는 "다음" 버튼이 화면에 보인다.', async () => {
    customRenderWithMaster(<NextRoundButton />);
  ...
  it('방장이 아닌 참여자는 비활성화 되어 있는 "방장이 진행해 주세요" 버튼이 화면에 보인다.', async () => {
    customRenderWithNotMaster(<NextRoundButton />);
