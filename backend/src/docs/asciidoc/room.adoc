...
include::{snippets}/room/stop/curl-request.adoc[]

==== request

include::{snippets}/room/stop/http-request.adoc[]

include::{snippets}/room/stop/path-parameters.adoc[]

==== response

include::{snippets}/room/stop/http-response.adoc[]
