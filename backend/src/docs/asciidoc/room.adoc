...
include::{snippets}/room/activate/curl-request.adoc[]

==== request

include::{snippets}/room/activate/http-request.adoc[]

include::{snippets}/room/activate/path-parameters.adoc[]

==== response

include::{snippets}/room/activate/http-response.adoc[]

response fields

include::{snippets}/room/activate/response-fields.adoc[]
