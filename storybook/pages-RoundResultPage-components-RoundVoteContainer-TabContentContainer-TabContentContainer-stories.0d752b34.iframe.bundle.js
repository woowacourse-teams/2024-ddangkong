...
`,profileImage=emotion_react_browser_esm.AH`
  width: 1.8rem;
  height: 1.8rem;
`;var useGetUserInfo=__webpack_require__("./src/hooks/useGetUserInfo.ts");const NicknameItem=({nickName,imageUrl})=>{const{member}=(0,useGetUserInfo.A)(),isMyNickname=member.nickname===nickName;return(0,emotion_react_jsx_runtime_browser_esm.FD)("li",{css:nicknameItemLayout,children:[(0,emotion_react_jsx_runtime_browser_esm.Y)("img",{src:imageUrl,alt:"사용자 프로필",css:profileImage}),(0,emotion_react_jsx_runtime_browser_esm.Y)("span",{css:nicknameText(isMyNickname),children:nickName})]})},NicknameItem_NicknameItem=NicknameItem;NicknameItem.__docgenInfo={description:"",methods:[],displayName:"NicknameItem",props:{nickName:{required:!0,tsType:{name:"string"},description:""},imageUrl:{required:!0,tsType:{name:"string"},description:""}}};const optionParticipantsLayout=emotion_react_browser_esm.AH`
  display: flex;
  flex-direction: column;
  gap: 2rem;
  width: 100%;
...
//# sourceMappingURL=pages-RoundResultPage-components-RoundVoteContainer-TabContentContainer-TabContentContainer-stories.0d752b34.iframe.bundle.js.map